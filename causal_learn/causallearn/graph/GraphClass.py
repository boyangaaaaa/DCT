...
from causal_learn.causallearn.graph.Edge import Edge
from causal_learn.causallearn.graph.Endpoint import Endpoint
from causal_learn.causallearn.graph.GeneralGraph import GeneralGraph
from causal_learn.causallearn.graph.GraphNode import GraphNode
from causal_learn.causallearn.graph.Node import Node
from causal_learn.causallearn.utils.GraphUtils import GraphUtils
from causal_learn.causallearn.utils.PCUtils.Helper import list_union, powerset
...
class CausalGraph:
    ...
    def draw_pydot_graph(self, labels: List[str] | None = None, dirctory: str | None = None):
        """Draw nx_graph if skel = False and draw nx_skel otherwise"""
        warnings.filterwarnings("ignore", category=UserWarning)
