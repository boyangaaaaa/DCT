...
We provide two examples of running the test in `example_to_use.ipynb` and running the PC algorithm with DCT as the test in `example_to_use_pc.ipynb`.
